...
inputrow1 = dbc.Row(
    [dbc.Col(
        dbc.FormGroup([
            dbc.Label("Enter start date: (yyyy-mm-dd)"),
            dbc.Input(id="bid", type="text", value="YYYY-MM-DD"),
                       ])
            )
    ])
...
inputrow1_1 = dbc.Row([
    dbc.Col(
        dbc.FormGroup([
            dbc.Label("Enter end date: (yyyy-mm-dd)"),
            dbc.Input(id="ask", type="text", value="YYYY-MM-DD"),
                       ])
        ,
        width=7
            )
...
app.layout =dbc.Container([
                ...
                dbc.Row(
                    [dbc.Col(
                        [html.P('Through this dashboard you can create graphs for a specific range based on a Mint Tower fund and an index.'),
